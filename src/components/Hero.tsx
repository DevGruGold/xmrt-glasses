        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="bg-teal-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-teal-700 transition-all duration-300 transform hover:scale-105"
              >
                Request a Demo
              </button>
              <button className="border-2 border-teal-600 text-teal-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-teal-600 hover:text-white transition-all duration-300">
                Buy Now
              </button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-xl shadow-lg">
              ...
              <div className="text-lg font-semibold text-teal-600">Confidence: 87%</div>
            </div>
          </div>
        </div>
...
const TestimonialSlider = () => {
  ...
  return (
    <div className="relative bg-white rounded-2xl p-8 shadow-lg max-w-4xl mx-auto">
